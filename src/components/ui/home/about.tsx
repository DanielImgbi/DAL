  ...
  return (
    <section className="w-screen  my-2 ">
      <div className="w-full flex flex-col lg:flex-row sticky ">
        ...
        >
          <div className="px-[1.37rem] pt-[4.5rem] pb-[3rem] space-y-[8rem] lg:px-[6rem]">
            <div className=" flex flex-col items-center lg:items-baseline">
              <span className="font-anton-sc leading-[100%]  text-red-950 text-4xl font-bold mb-2">
                <TextReveal
                  splitType="lines"
                  direction="up"
                  duration={0.7}
              ...
              <h2 className="flex flex-col items-center text-red-950/80  leading-[110%] text-[2rem] font-anton-sc  mb-4 lg:text-[3rem] lg:text-start lg:items-baseline">
                Creative Brands, Powerful Websites
              </h2>

              <p className="flex flex-col gap-8 text-black text-center text-inverse-muted space-x-2.5 text-al font-normal leading-[170%] lg:text-start">
                {[
        ...
        <div className="relative h-full pt-[4.5rem] flex justify-center items-center w-full lg:w-1/2">
          <DiagonalReveal
            className=""
            duration={2}
            delay={0.1}
