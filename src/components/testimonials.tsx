...
const testimonials = [
  {
    ...
    quote:
      "Frameit transformed my clients' family photos into stunning wall art. The quality of their frames and attention to detail is unmatched. I recommend them to all my clients.",
    rating: 5,
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=200",
    quote:
      "As someone who values quality craftsmanship, I'm impressed by Frameit's work. Their custom frames have enhanced my collection significantly. The team truly understands art preservation.",
    rating: 5,
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=200",
    quote:
      "I partner with Frameit to offer my wedding clients premium framing options. My customers are always thrilled with the results, and it's added significant value to my photography packages.",
    rating: 5,
  },
  {
    name: "David Chen",
