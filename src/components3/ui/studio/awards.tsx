...
import ParallaxMarquee from "../../common/parallax-text";
...
const Awards = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-background min-h-screen z-20"
    >
      <main>
        {/* <header className="w-[90%] mx-auto max-w-[1440px] py-[6rem] space-y-[6rem]">
          <div>
            ...
            <p className="text-[3.75rem] font-semibold leading-[120%] tracking-[-0.125rem]">
              {["We're a studio with diverse roots", "that want to help companies."].map(
                (lines, i) => (
                  <TextReveal
                    splitType="lines"
                    direction="up"
